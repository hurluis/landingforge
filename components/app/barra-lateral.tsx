    ...
    <div className="flex h-full flex-col gap-2 p-3">
      <div className="flex items-center justify-between gap-2 px-1 py-2">
        <Link
          ...
          className={cn(
            "font-[family-name:var(--font-round)] text-[1rem] leading-none tracking-[-0.02em] text-ash no-underline",
      ...
      <div className="mt-auto flex flex-col gap-3">
        ...
        >
          ...
          <p className="mt-1 flex items-baseline gap-1.5">
            <span className="font-[family-name:var(--font-round)] text-[1.5rem] font-[350] leading-none tabular-nums text-ash">
