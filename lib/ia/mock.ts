...
function respuestaLocal(pregunta: string): string {
  ...
  if (/(precio|cuesta|plan|cu[aá]nto|vale)/.test(q)) {
    return "Cuatro planes en dólares: Semilla US$12 con 30 secciones, Estudio US$35 con 120, Agencia US$99 con 400, y Fundición US$200 con 900 incluidas y sin tope. Un crédito es una sección con su prompt y su imagen. Empieza con las 5 gratis, sin tarjeta.";
  }
